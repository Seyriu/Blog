...
public class PostEntity implements Serializable{
  ...
  public List<PostPerTagEntity> getTag() {
    return tag;
  }

  public void setTag(List<PostPerTagEntity> tag) {
    this.tag = tag;
  }
  ...
  public String toString() {
    return "PostEntity{" + "id=" + id + ", titolo=" + titolo + ", descrizione=" + descrizione + ", dataPost=" + dataPost + ", visibile=" + visibile + ", visite=" + visite + ", categoria=" + categoria + ", utente=" + utente + ", commenti=" + commenti + ", tag=" + tag + '}';
  }
